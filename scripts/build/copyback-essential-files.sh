...
#Chromium120 more
cp $origin_dir/src/third_party/grpc/grpc_library.gni src/third_party/grpc

mkdir -p src/components/test/data/update_client/puffin_patch_test/
cp $origin_dir/src/components/test/data/update_client/puffin_patch_test/BUILD.gn src/components/test/data/update_client/puffin_patch_test
